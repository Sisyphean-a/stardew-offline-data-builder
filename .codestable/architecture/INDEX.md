...
- 架构决定：[`requirements/adrs/001-official-assets-as-source-of-truth.md`](../requirements/adrs/001-official-assets-as-source-of-truth.md)、[`requirements/adrs/002-quality-gated-publish-artifacts.md`](../requirements/adrs/002-quality-gated-publish-artifacts.md)。
