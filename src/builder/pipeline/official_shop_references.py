    ...
    return compact(
        {
            ...
            "shopPriceModifierMode": shop.get("PriceModifierMode"),
            "shopApplyProfitMargins": shop.get("ApplyProfitMargins"),
            "itemId": item.get("ItemId"),
            "randomItemIds": item.get("RandomItemId"),
            "price": item.get("Price"),
            "useObjectDataPrice": item.get("UseObjectDataPrice"),
            "ignoreShopPriceModifiers": item.get("IgnoreShopPriceModifiers"),
            "itemApplyProfitMargins": item.get("ApplyProfitMargins"),
            "priceModifiers": item.get("PriceModifiers"),
            "priceModifierMode": item.get("PriceModifierMode"),
